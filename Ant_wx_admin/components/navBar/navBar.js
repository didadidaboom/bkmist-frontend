Component({
  ...
  methods: {
    setStyle: function(life) {
      ...
      let navigationbarplaceholderStyle = [
        `color: ${this.data.placecolor}`,
        `height:${this.data.placehight}rpx`,
        `background: ${this.data.placebackground}`,
        `font-size:${this.data.placefontsize}rpx`,
        `padding-top:${navBarHeight+navBarExtendHeight+statusBarHeight}px`,
        `padding-bottom:${navBarExtendHeight}px`
      ].join(';');
      let navBarLeft = [];
