...
Page({
    ...
    changeNotificationStatus_askme:function(e){
        var notification_id = e.currentTarget.dataset.notify_id;
        var user_id = e.currentTarget.dataset.user_id;
        var userhaschecked = e.currentTarget.dataset.userhaschecked
        var index = e.currentTarget.dataset.index
        ...
        promise.then((res)=>{
            if(res.statusCode==200){
                ...
                wx.navigateTo({
                  url: '/pages/askMeDetails/askMeDetails?tacitrecord_id='+tacitid,
                })
            }else{
                wx.showToast({
                  title: '网络异常，请稍后',
    ...
    changeNotificationStatus_initTacit:function(e){
        var notification_id = e.currentTarget.dataset.notify_id;
        var user_id = e.currentTarget.dataset.user_id;
        var userhaschecked = e.currentTarget.dataset.userhaschecked
        var index = e.currentTarget.dataset.index
    ...
    changeNotificationStatus_initAskMe:function(e){
        var notification_id = e.currentTarget.dataset.notify_id;
        var user_id = e.currentTarget.dataset.user_id;
        var userhaschecked = e.currentTarget.dataset.userhaschecked
        var index = e.currentTarget.dataset.index
